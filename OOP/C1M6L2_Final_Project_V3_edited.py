...
def calculate_frequencies(file_contents):
    ...
    punctuations = '''!()-[]{};:'"\,<>./?@#$%^&*_~'''
    uninteresting_words = ["the", "a", "to", "if", "is", "it", "of", "and", "or", "an", "as", "i", "me", "my",     "we", "our", "ours", "you", "your", "yours", "he", "she", "him", "his", "her", "hers", "its", "they", "them",     "their", "what", "which", "who", "whom", "this", "that", "am", "are", "was", "were", "be", "been", "being",     "have", "has", "had", "do", "does", "did", "but", "at", "by", "with", "from", "here", "when", "where", "how",     "all", "any", "both", "each", "few", "more", "some", "such", "no", "nor", "too", "very", "can", "will", "just",     "for", "could", "not", "really"] # my addition
    
    # LEARNER CODE START HERE
    word_dict = {} 
    
    char_list = file_contents.lower().split()
    
    for word in char_list:
        word = word.strip(punctuations)
        
        if word.isalpha() and word not in uninteresting_words and word not in word_dict and len(word) > 2:
            word_dict[word] = char_list.count(word)
